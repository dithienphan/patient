...
) TABLESPACE patientspace ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS titel (
    ...
    patient_id     CHAR(36) UNIQUE NOT NULL references patient(id)
) TABLESPACE patientspace ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS abbildung (
    ...
    patient_id         CHAR(36) NOT NULL references patient(id),

    INDEX abbildung_patient_id_idx(patient_id)
) TABLESPACE patientspace ROW_FORMAT=COMPACT;
