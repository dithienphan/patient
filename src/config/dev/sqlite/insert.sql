...
-- "Design Patterns"
-- "Freiburger Chorpatient"
-- "Maschinelle Lernverfahren zur Behandlung von Bonitätsrisiken im Mobilfunkgeschäft"
-- "Software Pioneers"

INSERT INTO patient(id, version, isbn, rating, art, preis, rabatt, lieferbar, datum, homepage, schlagwoerter, erzeugt, aktualisiert) VALUES
...
INSERT INTO titel(id, titel, untertitel, patient_id) VALUES
    (1,'Alpha','alpha',1);
INSERT INTO titel(id, titel, untertitel, patient_id) VALUES
    (20,'Beta',null,20);
INSERT INTO titel(id, titel, untertitel, patient_id) VALUES
...
INSERT INTO abbildung(id, beschriftung, content_type, patient_id) VALUES
    (1,'Abb. 1','img/png',1);
INSERT INTO abbildung(id, beschriftung, content_type, patient_id) VALUES
    (20,'Abb. 1','img/png',20);
INSERT INTO abbildung(id, beschriftung, content_type, patient_id) VALUES
