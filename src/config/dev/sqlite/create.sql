...
CREATE INDEX IF NOT EXISTS patient_isbn_idx ON patient(isbn);

CREATE TABLE IF NOT EXISTS titel (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    titel       TEXT NOT NULL,
    untertitel  TEXT,
    patient_id     INTEGER NOT NULL UNIQUE REFERENCES patient
);
...
CREATE INDEX IF NOT EXISTS abbildung_patient_id_idx ON abbildung(patient_id);
