...
# Aufruf:   docker buildx build --tag juergenzimmermann/patient:2023.1.0 .
#           ggf. --no-cache
...
COPY --from=builder --chown=app:app /app/src/patient/graphql/schema.graphql ./dist/patient/graphql/
