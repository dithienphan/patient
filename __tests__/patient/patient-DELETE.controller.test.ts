...
describe('DELETE /rest/patienten', () => {
    ...
    test('Vorhandenen patienten loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Patienten loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Patienten loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
